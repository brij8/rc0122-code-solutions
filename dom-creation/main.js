...
function renderPokemon(pokemon) {
  ...
  var $pCardText = document.createElement('div');
  $pCardText.className = 'pokemon-card-text';
  $pokeCard.appendChild($pCardText);

  var $h2 = document.createElement('h2');
  var $name = document.createTextNode(pokemon.name);
  $h2.appendChild($name);
  $pCardText.appendChild($h2);

  var $h3 = document.createElement('h3');
  var $num = document.createTextNode(pokemon.number);
  $h3.appendChild($num);
  $pCardText.appendChild($h3);

  var $p = document.createElement('p');
  var $desc = document.createTextNode(pokemon.description);
  $p.appendChild($desc);
  $pCardText.appendChild($p);
