...
console.log('value of newFunc: ', newFunc);
console.log('typeof newFunc: ', typeof newFunc);

var newStr = new String();
console.log('value of newStr: ', newStr);
...
var newBoo = new Boolean();
console.log('value of newBoo: ', newBoo);
